...
/**
 * TblOrderItemRscAud generated by hbm2java
 */
@Entity
@Table(name = "tbl_order_item_rsc_aud", catalog = "crmord")
public class TblOrderItemRscAud implements java.io.Serializable {

	private TblOrderItemRscAudId id;
	...
	public TblOrderItemRscAud() {
	}

	public TblOrderItemRscAud(TblOrderItemRscAudId id) {
		this.id = id;
	}

	public TblOrderItemRscAud(TblOrderItemRscAudId id, Byte revtype, Long orderId, Long orderItemId, String rscType,
			String rscDtl, String reserveRef, String status, String markDelInd, Integer refTxnId,
	...
	public TblOrderItemRscAudId getId() {
		return this.id;
	}

	public void setId(TblOrderItemRscAudId id) {
		this.id = id;
	}
