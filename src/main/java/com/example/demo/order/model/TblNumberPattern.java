...
/**
 * TblNumberPattern generated by hbm2java
 */
@Entity
@Table(name = "tbl_number_pattern", catalog = "crmord")
public class TblNumberPattern implements java.io.Serializable {
	...
	public TblNumberPattern() {
	}

	public TblNumberPattern(String type, long lastNumberUsed, long numberLength) {
		this.type = type;
		this.lastNumberUsed = lastNumberUsed;
		this.numberLength = numberLength;
	}

	public TblNumberPattern(String type, String PType, String shortForm, long lastNumberUsed,
			String lastDateElementUsed, long numberLength, String dateElementFormat, String resetOnDateElement,
			String separatorChar, String requireCheckDigit, String createProleType, Long createProleId,
