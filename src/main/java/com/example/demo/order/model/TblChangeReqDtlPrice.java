...
/**
 * TblChangeReqDtlPrice generated by hbm2java
 */
@Entity
@Table(name = "tbl_change_req_dtl_price", catalog = "crmord")
public class TblChangeReqDtlPrice implements java.io.Serializable {
	...
	public TblChangeReqDtlPrice() {
	}

	public TblChangeReqDtlPrice(long recordId) {
		this.recordId = recordId;
	}

	public TblChangeReqDtlPrice(long recordId, Long changeReqId, Long changeReqDtlId, Long orderId, Long orderItemId,
			Long orderItemPriceId, String actionInd, Long priceId, String priceType, String priceDesc, Float priceValue,
			Long altPriceRefId, Float altPrice, String name, String recurChrgPeriodType, Float recurChrgPeriodLength,
			String unit, String taxRequired, Float taxRate, Float taxIncludedAmount, String actionType, String billDesc,
			Long applyToPriceId, BigDecimal percentage, BigDecimal chrgAmount, BigDecimal duration, String priceSubType,
	...
	public Long getOrderItemPriceId() {
		return this.orderItemPriceId;
	}

	public void setOrderItemPriceId(Long orderItemPriceId) {
		this.orderItemPriceId = orderItemPriceId;
	}
