...
/**
 * TblFollowupTask generated by hbm2java
 */
@Entity
@Table(name = "tbl_followup_task", catalog = "crmord")
public class TblFollowupTask implements java.io.Serializable {
	...
	public TblFollowupTask() {
	}

	public TblFollowupTask(String taskType, String taskNature, String url, String method, String header, String body,
			Long fulfillOrderId, Long orderId, Long orderItemId, String status, Long txnId, String txnReqDtl,
			String txnRespDtl, String remark, String errorMsg, String refCode, String notifyPartyUuid,
			String assignedUser, Date createTime, Date notifyTime, Date assignTime, Date executeTime, Date skipTime,
			String createBy, String notifyBy, String assignBy, String executeBy, String skipBy) {
