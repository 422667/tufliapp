...
/**
 * TblRscTxn generated by hbm2java
 */
@Entity
@Table(name = "tbl_rsc_txn", catalog = "crmord")
public class TblRscTxn implements java.io.Serializable {
	...
	public TblRscTxn(long recordId) {
		this.recordId = recordId;
	}

	public TblRscTxn(long recordId, String caller, String txnCode, String txnType, String txnRefId, String txnRefSys,
