...
/**
 * TblOrderItemMetaAud generated by hbm2java
 */
@Entity
@Table(name = "tbl_order_item_meta_aud", catalog = "crmord")
public class TblOrderItemMetaAud implements java.io.Serializable {

	private TblOrderItemMetaAudId id;
	...
	public TblOrderItemMetaAud() {
	}

	public TblOrderItemMetaAud(TblOrderItemMetaAudId id) {
		this.id = id;
	}

	public TblOrderItemMetaAud(TblOrderItemMetaAudId id, Byte revtype, Long orderId, Long orderItemId, String name,
			String value, String markDelInd, String createProleType, Long createProleId, String createProleName,
	...
	public TblOrderItemMetaAudId getId() {
		return this.id;
	}

	public void setId(TblOrderItemMetaAudId id) {
		this.id = id;
	}
