...
/**
 * TblFulfillOrderReqAud generated by hbm2java
 */
@Entity
@Table(name = "tbl_fulfill_order_req_aud", catalog = "crmord")
public class TblFulfillOrderReqAud implements java.io.Serializable {

	private TblFulfillOrderReqAudId id;
	...
	public TblFulfillOrderReqAud() {
	}

	public TblFulfillOrderReqAud(TblFulfillOrderReqAudId id) {
		this.id = id;
	}

	public TblFulfillOrderReqAud(TblFulfillOrderReqAudId id, Byte revtype, Long fulfillOrderId, String rtnRefId,
			String rtnType, Long rtnId, String rtnCode, String rtnDesc, Long refTxnId, String rtnOrderNo,
			String rtnLevel, Date rtnTimestamp, Date rtnReceiveDate, Date rtnFinishDate, String createProleType,
	...
	public TblFulfillOrderReqAudId getId() {
		return this.id;
	}

	public void setId(TblFulfillOrderReqAudId id) {
		this.id = id;
	}
