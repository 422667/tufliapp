...
/**
 * TblChangeReqDtl generated by hbm2java
 */
@Entity
@Table(name = "tbl_change_req_dtl", catalog = "crmord")
public class TblChangeReqDtl implements java.io.Serializable {
	...
	public TblChangeReqDtl() {
	}

	public TblChangeReqDtl(long recordId) {
		this.recordId = recordId;
	}

	public TblChangeReqDtl(long recordId, Long changeReqId, Long orderId, String orderItemId, String status,
			String reqType, String reqReason, Date reqExecuteDate, Date reqActualExecuteDate, Date expComplDate,
			String errMsg, String createProleType, Long createProleId, String createProleName, String createProleCode,
