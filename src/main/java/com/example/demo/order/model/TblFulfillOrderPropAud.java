...
/**
 * TblFulfillOrderPropAud generated by hbm2java
 */
@Entity
@Table(name = "tbl_fulfill_order_prop_aud", catalog = "crmord")
public class TblFulfillOrderPropAud implements java.io.Serializable {

	private TblFulfillOrderPropAudId id;
	...
	public TblFulfillOrderPropAud() {
	}

	public TblFulfillOrderPropAud(TblFulfillOrderPropAudId id) {
		this.id = id;
	}

	public TblFulfillOrderPropAud(TblFulfillOrderPropAudId id, Byte revtype, Long fulfillOrderId, String type,
			String name, String value, String createProleType, Long createProleId, String createProleName,
	...
	public TblFulfillOrderPropAudId getId() {
		return this.id;
	}

	public void setId(TblFulfillOrderPropAudId id) {
		this.id = id;
	}
