...
/**
 * TblFulfillOrderAud generated by hbm2java
 */
@Entity
@Table(name = "tbl_fulfill_order_aud", catalog = "crmord")
public class TblFulfillOrderAud implements java.io.Serializable {

	private TblFulfillOrderAudId id;
	private Byte revtype;
	private String type;
	private Long orderId;
	private Long PFulfillOrderId;
	private String triggerBy;
	private String actionType;
	private String status;
	private String latestRtnRefId;
	private Integer dependOnForderId;
	...
	public TblFulfillOrderAud() {
	}

	public TblFulfillOrderAud(TblFulfillOrderAudId id) {
		this.id = id;
	}

	public TblFulfillOrderAud(TblFulfillOrderAudId id, Byte revtype, String type, Long orderId, Long PFulfillOrderId,
			String triggerBy, String actionType, String status, String latestRtnRefId, Integer dependOnForderId,
			String dependType, String dependRtnCode, Date complDate, Date requestExecuteTime, String reachedPonr,
			String code, String referenceCode, String createProleType, Long createProleId, String createProleName,
		...
		this.PFulfillOrderId = PFulfillOrderId;
	...
	public TblFulfillOrderAudId getId() {
		return this.id;
	}

	public void setId(TblFulfillOrderAudId id) {
		this.id = id;
	}
	...
	@Column(name = "p_fulfill_order_id")
	public Long getPFulfillOrderId() {
		return this.PFulfillOrderId;
	}

	public void setPFulfillOrderId(Long PFulfillOrderId) {
		this.PFulfillOrderId = PFulfillOrderId;
	}
	...
	public Integer getDependOnForderId() {
		return this.dependOnForderId;
	}

	public void setDependOnForderId(Integer dependOnForderId) {
		this.dependOnForderId = dependOnForderId;
	}
